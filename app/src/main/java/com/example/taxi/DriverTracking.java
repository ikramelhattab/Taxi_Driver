...
import com.example.taxi.Helper.DirectionJSONParser;
...
GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent()!=null){
            clientlat = getIntent().getDoubleExtra("lat",-1.0);
            clientlng = getIntent().getDoubleExtra("lng",-1.0);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        cltMarker = mMap.addCircle(new CircleOptions()
        .center(new LatLng(clientlat,clientlng))
        .radius(50)
        ...
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(clientlat,clientlng),0.05f);
    ...
    private void sendArrivedNotification(String customerId) {
        ...
        // Notification : title is "Arrived" body "The driver %s has arrived at your location"
    ...
    public boolean checkPlaySercices() {
